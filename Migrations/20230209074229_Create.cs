        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ISO3166code = table.Column<string>(name: "ISO 3166 code", type: "TEXT", maxLength: 2, nullable: false)
                },
                constraints: table =>
                {
